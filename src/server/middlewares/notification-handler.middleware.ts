...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': { roles: ['owner', 'waiter', 'chef'], key: 'order_id', tenantPath: [], userPath: [] },
  'order_updated.update': { roles: ['owner', 'chef'], key: 'order_id', tenantPath: [], userPath: [] },
  'order_completed.update': { roles: ['owner', 'waiter'], key: 'order_id', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['owner', 'waiter', 'chef'];
